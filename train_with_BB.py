...
for i_epoch in range(1, nb_epoch+1):
    losses = []
    t0 = time.time()
    for template, search, cx0, cy0 in tqdm.tqdm(miceset_loader):
        optimizer.zero_grad()

        # Generate random bounding box 
        bb = BB_from_centers(cx0[0],cy0[0])
    ...
    if i_epoch % 5 == 0 :
        torch.save(model.state_dict(), f'Training_withBB_model_epoch{i_epoch}')
